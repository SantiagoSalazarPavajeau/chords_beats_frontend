...
class Song{
    ...
    beat(src){
        let beat = createNewBeatAudio(src)
        return beat;
    }
    ...
    renderSongButton(){ //called on load and on save of song
        let songContainer = createSongContainer()
        let songButton = createSongButton(this.name)
        ...
        let deleteSongButton = createDeleteSongButton()
